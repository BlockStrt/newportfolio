    ...
    <section id='contact'
     ...
     items-center justify-center'>
        ...
        <p className='max-w-[600px] text-center text-textDark'>
            Currently seeking employment. As a motivated web developer, you are tirelessly seeking new opportunities to expand your skill set and make meaningful contributions to the ever-evolving digital landscape.
        </p>
